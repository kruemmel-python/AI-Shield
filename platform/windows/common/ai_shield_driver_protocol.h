...
#define AI_SHIELD_ABI_FREEZE_REVISION 3U
...
#define AI_SHIELD_IOCTL_REGISTER_BROKER CTL_CODE(AI_SHIELD_DEVICE_TYPE, 0x803U, METHOD_BUFFERED, FILE_WRITE_ACCESS)
#define AI_SHIELD_IOCTL_SET_FILE_VERDICT CTL_CODE(AI_SHIELD_DEVICE_TYPE, 0x804U, METHOD_BUFFERED, FILE_WRITE_ACCESS)
#define AI_SHIELD_IOCTL_REGISTER_ISOLATED_PROCESS CTL_CODE(AI_SHIELD_DEVICE_TYPE, 0x805U, METHOD_BUFFERED, FILE_WRITE_ACCESS)
#define AI_SHIELD_IOCTL_ADMIN_FILE_VERDICT CTL_CODE(AI_SHIELD_DEVICE_TYPE, 0x806U, METHOD_BUFFERED, FILE_WRITE_ACCESS)
#define AI_SHIELD_MINIFILTER_PORT_NAME L"\\AIShieldMinifilterPort"
#define AI_SHIELD_ANALYSIS_PATH_CHARS 1024U
...
#define AI_SHIELD_FILE_PENDING 0U
#define AI_SHIELD_FILE_CLEAN 1U
#define AI_SHIELD_FILE_QUARANTINED 2U
...
typedef struct _AI_SHIELD_BROKER_REGISTRATION {
    ULONG Version;
    ULONG Size;
    ULONGLONG ProcessId;
} AI_SHIELD_BROKER_REGISTRATION;

typedef struct _AI_SHIELD_FILE_VERDICT {
    ULONG Version;
    ULONG Size;
    ULONGLONG FileId;
    ULONG VolumeId;
    ULONG Verdict;
} AI_SHIELD_FILE_VERDICT;

typedef struct _AI_SHIELD_FILE_ANALYSIS_REQUEST {
    ULONG Version;
    ULONG Size;
    ULONGLONG RequestId;
    ULONGLONG FileId;
    ULONG VolumeId;
    ULONG PathLength;
    WCHAR Path[AI_SHIELD_ANALYSIS_PATH_CHARS];
} AI_SHIELD_FILE_ANALYSIS_REQUEST;

typedef struct _AI_SHIELD_FILE_ANALYSIS_REPLY {
    ULONG Version;
    ULONG Size;
    ULONGLONG RequestId;
    ULONG Verdict;
    ULONG Reserved;
} AI_SHIELD_FILE_ANALYSIS_REPLY;
...
AI_SHIELD_ABI_ASSERT(sizeof(AI_SHIELD_BROKER_REGISTRATION) == 16U);
AI_SHIELD_ABI_ASSERT(sizeof(AI_SHIELD_FILE_VERDICT) == 24U);
AI_SHIELD_ABI_ASSERT(sizeof(AI_SHIELD_FILE_ANALYSIS_REQUEST) == 2080U);
AI_SHIELD_ABI_ASSERT(FIELD_OFFSET(AI_SHIELD_FILE_ANALYSIS_REQUEST, RequestId) == 8U);
AI_SHIELD_ABI_ASSERT(FIELD_OFFSET(AI_SHIELD_FILE_ANALYSIS_REQUEST, FileId) == 16U);
AI_SHIELD_ABI_ASSERT(FIELD_OFFSET(AI_SHIELD_FILE_ANALYSIS_REQUEST, VolumeId) == 24U);
AI_SHIELD_ABI_ASSERT(FIELD_OFFSET(AI_SHIELD_FILE_ANALYSIS_REQUEST, Path) == 32U);
AI_SHIELD_ABI_ASSERT(sizeof(AI_SHIELD_FILE_ANALYSIS_REPLY) == 24U);
AI_SHIELD_ABI_ASSERT(FIELD_OFFSET(AI_SHIELD_FILE_ANALYSIS_REPLY, RequestId) == 8U);
AI_SHIELD_ABI_ASSERT(FIELD_OFFSET(AI_SHIELD_FILE_ANALYSIS_REPLY, Verdict) == 16U);
