...
Diese Datei bewertet die vollständige Entwicklungs- und Integrationsplattform. Die davon getrennte
Bewertung für einen privaten Windows-Einzelplatzrechner steht unter
[`editions/private_desktop/SOFTWAREBEWERTUNG_PRIVAT.md`](editions/private_desktop/SOFTWAREBEWERTUNG_PRIVAT.md).
...
| Automatisierte Tests | 11 CTest-Ziele, zuletzt in Debug und Release erfolgreich |
...
| Datei- und Prozessschutz | 7,5/10 | Handle-basierte Quarantäne und konkrete ProcessGuard-Regeln; Schutzabdeckung bleibt begrenzt |
...
in Benutzer-Downloads und lokalem Temp, ausgewählte ausführbare oder skriptfähige Erweiterungen,
maximal 256 MiB und Internet-Provenance über Mark-of-the-Web Zone 3 oder 4. Netzlaufwerke,
beliebige Dateitypen und jeder denkbare Schreibpfad werden damit nicht vollständig abgedeckt.
...
- Browser-Native-Messaging-Host und Browser-Sensor sind gebaut und lokal testsigniert, aber ohne
  reale Extension-ID und HTTPS-Update-URL nicht ausgerollt.
...
- riskante Downloads mit Internet-Provenance und ausgewählten ausführbaren Formaten;
...
[`docs/FEHLENDE_FUNKTIONEN_DE.md`](docs/FEHLENDE_FUNKTIONEN_DE.md) gepflegt.
